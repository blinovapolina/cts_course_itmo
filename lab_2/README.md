...
Даже при корректном Dockerfile неправильный compose-файл может разрушить изоляцию контейнеров или привести к непредсказуемому поведению.

В данной работе мы рассмотрим примеры неправильного и правильного compose-файла и разберём, как исправления влияют на качество проекта.
...
3. Принудительно указан network_mode: `bridge`
   Обходит встроенный сетевой механизм Docker Compose и усложняет изоляцию.
